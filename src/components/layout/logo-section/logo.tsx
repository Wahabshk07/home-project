...
export async function LogoSection() {
  ...
  return (
    <section className="relative w-screen max-w-[100vw] overflow-hidden py-10 md:py-12 ml-[calc(50%-50vw)] bg-transparent">
      ...
      {/* Carousel Wrapper - Full Width with no restrictions */}
      <div className="mt-8 md:mt-10 w-full">
        {/* 
            Note: We use a mask-image to create a soft fade on the left/right 
            which looks very modern and professional 
        */}
