...
export default function JobPackagesAdminPage() {
  ...
  return (
    <div className="w-full px-12 py-8 md:py-10 lg:py-12 ">
      ...
      <section className="mb-10 rounded-[32px] border border-amber-200/80 bg-amber-50/40 p-6 shadow-sm sm:p-8">
        ...
        <form onSubmit={saveFreeTier} className="flex max-w-md flex-col gap-4 sm:flex-row sm:items-end">
          ...
          <button
            type="submit"
            disabled={freeTierSaving || loading}
            className="shrink-0 rounded-xl bg-amber-600 px-6 py-3 text-sm font-bold text-white transition hover:bg-amber-700 disabled:opacity-50"
          >
